...
- [Red Hat Enterprise Linux source code no longer available to the public: This effects various downstream distros based on it](https://gadgeteer.co.za/red-hat-enterprise-linux-source-code-no-longer-available-to-the-public-this-effects-various-downstream-distros-based-on-it/)
